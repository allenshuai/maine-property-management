...
export default function ContactPage() {
  return (
    <div className="md:mt-8 flex flex-col min-h-screen px-6 md:px-16 py-12 max-w-screen-xl mx-auto">
      <div className="flex flex-col md:flex-row justify-between md:items-start mb-12 text-gray-700">
        <h1 className="text-3xl md:text-4xl font-bold md:w-1/2 flex-1">Contact</h1>
